...
#	Rename-Item D:\jenkins-slave\workspace\GHS-Android-Email_Notifier-Regression\Phone\*_$i.html -newname Regression_$i.html	
#	$i++
#}
...
while ($i -le $n)
{
	while ($j -lt $n)
	{
		...
		$Filepath = "D:\jenkins-slave\workspace\GHS-Android-Email_Notifier-Regression\Phone\" + $i+ "_Automation_report_" + $Device_info + ".html"
